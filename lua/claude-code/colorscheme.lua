...
if vim.o.background == 'light' then
  ...
  colorscheme.editorBackground = config.transparent and 'none' or '#30302E'
  ...
  colorscheme.syntaxError = '#C075D7'
  colorscheme.syntaxFunction = '#E6C07A'
  colorscheme.warningText = '#ff9800'
  colorscheme.syntaxKeyword = '#b392f0'
  colorscheme.functionName = '#5FACEA'
  colorscheme.jsxComponent = '#E06C75'
  colorscheme.importedItem = '#60ADED'
  colorscheme.linkText = '#9db1c5'
  colorscheme.stringText = '#97C278'
  colorscheme.warningEmphasis = '#AAB2BF'
  colorscheme.successText = '#22863a'
