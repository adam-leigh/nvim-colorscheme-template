...
local function set_groups()
  ...
  local groups = {
    ...
    Function = { fg = colorscheme.functionName },
    ...
    ['@punctuation.delimiter'] = { fg = colorscheme.warningEmphasis },
    ['@punctuation.terminator.statement'] = { fg = colorscheme.syntaxError },
    ...
    ['@variable.import'] = { fg = colorscheme.importedItem },
    ...
    ['@keyword.import'] = { fg = colorscheme.syntaxError },
    ['@keyword.export'] = { fg = colorscheme.syntaxError },
    ['@keyword.return'] = { fg = colorscheme.warningEmphasis },
    ['@keyword.operator'] = { fg = colorscheme.warningEmphasis },
    -- ["@storageclass"] = {},
    -- ["@structure"] = {},
    ['@namespace'] = { link = 'Type' },
    ['@annotation'] = { link = 'Label' },
    ['@include'] = { fg = colorscheme.warningEmphasis },
    -- ["@preproc"] = {},
    ['@debug'] = { fg = colorscheme.specialKeyword },
    ['@tag'] = { fg = colorscheme.jsxComponent },
    ['@tag.builtin'] = { fg = colorscheme.jsxComponent },
    ['@tag.delimiter'] = { fg = colorscheme.warningEmphasis },
    ['@tag.attribute'] = { fg = colorscheme.syntaxKeyword },
    ['@tag.tsx'] = { fg = colorscheme.jsxComponent },
    ['@tag.jsx'] = { fg = colorscheme.jsxComponent },
